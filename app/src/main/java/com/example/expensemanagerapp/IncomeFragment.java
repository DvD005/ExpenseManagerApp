...
public class IncomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mIncomeDatabase= FirebaseDatabase.getInstance("https://expense-manager-35479-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("IncomeDatabase").child(uid);
        ...
        mIncomeDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                ...
                for (DataSnapshot mySnapShot: datasnapshot.getChildren()){
                    ...
                    incomeTotalSum.setText(strTotalValue+".00");
                }
            }
